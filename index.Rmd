...
total_sum <- data.frame("Level" = c("All Baseline Tests", "Baseline Tests Ages 12-18"), "Total" = c(85638, 80892))
...
```{r, include=FALSE}
age_12_mem_verbal <- age_12 %>% 
  select(verbal_memory) %>% 
  na.omit()
```

```{r, include=TRUE}
create_react(age_12_mem_verbal, verbal_memory)
```
